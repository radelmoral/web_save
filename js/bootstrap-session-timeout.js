            ...
            $('body').append('<div class="modal fade" id="session-timeout-dialog"> \
              <div class="modal-dialog"> \
                <div class="modal-content"> \
                    <div class="modal-header bg-danger d-flex justify-content-between align-items-center"> \
                  ...
                  <div class="modal-footer"> \
                    ...
                    <button id="session-timeout-dialog-keepalive" type="button" class="btn btn-success" data-bs-dismiss="modal">' + opt.keepAliveButton + '</button> \
                  </div> \
                </div> \
              </div> \
             </div>');
