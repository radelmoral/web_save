    ...
    <body>
        ...
        <script>
            ...
            ({  orderCellsTop:true,
                ...
                "ajax":
                    {
                        url: "datosOppo.php?accion=listar",
                        dataSrc: "" 
                    },
                "columns":
                [{"data": "referencia"},
            ...
            function agregarRegistro(registro)
                {
                    ...
                    {
                        type: 'POST',
                        url: "datosOppo.php?accion=agregar",
                        data: registro,
            ...
            function borrarRegistro(referencia)
                {
                    ...
                    {
                        type: 'GET',
                        url: "datosOppo.php?accion=borrar&referencia=" + referencia,
                        data: '',
                        success: function(msg)
                        {
                            tabla1.ajax.reload();
            ...
            function recuperarRegistro(referencia)
                {
                    $.ajax(
                        {
                            type: "GET",
                            url: "datosOppo.php?accion=consultar&referencia="+referencia,
                            data: '',
            ...
            function modificarRepuesto(registro)
                {
                    $.ajax(
                        {
                            type: "POST",
                            url: "datosOppo.php?accion=modificar&referencia=" + registro.referencia,
                            data: registro,
