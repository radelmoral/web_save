...
{
    case 'listarTiendas':
        $datos = mysqli_query($conexion, "SELECT idTienda, tienda FROM tiendas");
    ...
    case 'listarTipoPedido':
        $datos = mysqli_query($conexion, "SELECT idTipo, tipo FROM tipoPedido");
        $resultado = mysqli_fetch_all($datos,MYSQLI_ASSOC);
        echo json_encode($resultado);
        mysqli_close($conexion);
        break;
     ...
     case 'listarEstado':
        $datos = mysqli_query($conexion, "SELECT idEstado, estado FROM tipoEstado");
        $resultado = mysqli_fetch_all($datos,MYSQLI_ASSOC);
        echo json_encode($resultado);
        mysqli_close($conexion);
        break;
    ...
    case 'agregarCabecera':
        $respuesta = mysqli_query($conexion,"INSERT INTO pedidosCabecera (idUsuario, idTienda, idTipoPedido, fecha, estado) VALUES ('$_POST[idUsuario]', '$_POST[idTienda]', '$_POST[idTipoPedido]', '$_POST[fecha]'), '$_POST[idEstado]')");
