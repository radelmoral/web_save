...
<html lang="en" dir="ltr">
    ...
    <body>
        <div class="container">
                    ...
                    <div id="MenuNavegacion" class="collapse navbar-collapse">
                        <ul class="navbar-nav ms-3">
                           <?php
                            if ($_SESSION['rol']==1)
                            {
                               echo '<li class="nav-item"><a class="nav-link" href="javascript:formularioTelefono();">Añadir Telefono</a></li>
            ...
            <h1>Listado Teléfonos</h1>
            <div class="col-12">
                <table class="table table-striped table-bordered table-hover" id="telefonos">
                    <thead >
                        <tr>
                            <th>Referencia</th>
                            <th>Marca</th>
            ...
            <div class="modal fade" id="formularioTelefono" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" role="dialog"> 
        ...
        <script>
            ...
            let tabla3=$("#telefonos").DataTable
            ({  orderCellsTop:true,
                fixedHeader: true,
                "dom":"lrtip",
                ...
                "ajax":
                    {
                        url: "datosTelefonos.php?accion=listar",
                        dataSrc: "" 
                    },
                "columns":
                [{"data": "referencia"},
        ...
        $('#telefonos thead tr').clone(true).appendTo( '#telefonos thead' );

        $('#telefonos thead tr:eq(1) th').each( function (i) 
        {
            if(i<5)
           { 
                ...
                {
                    if ( tabla3.column(i).search() !== this.value ) 
                        {
                            tabla3
                            .column(i)
                            .search( this.value )
            ...
            function formularioTelefono()
                {
                    ...
                    document.getElementById("cabecera").innerText = "Nuevo teléfono";
                    document.getElementById("referencia").disabled = false;
                    pvp.value=0;
                    $("#formularioTelefono").modal('show');
                }
            ...
            function agregarRegistro(registro)
                {
                    ...
                    {
                        type: 'POST',
                        url: "datosTelefonos.php?accion=agregar",
                        data: registro,
            ...
            function borrarRegistro(referencia)
                {
                    ...
                    {
                        type: 'GET',
                        url: "datosTelefonos.php?accion=borrar&referencia=" + referencia,
                        data: '',
                        success: function(msg)
                        {
                            tabla3.ajax.reload();
            ...
            function recuperarRegistro(referencia)
                {
                    $.ajax(
                        {
                            type: "GET",
                            url: "datosTelefonos.php?accion=consultar&referencia=" + escape(referencia),
                            data: '',
            ...
            function modificarTelefono(registro)
                {
                    $.ajax(
                        {
                            type: "POST",
                            url: "datosTelefonos.php?accion=modificar&referencia=" + registro.referencia,
                            data: registro,
            ...
            $('#confirmarModificar').click(function()
                {
                    ...
                    $("#formularioTelefono").modal('hide');
                    modificarTelefono(registro);   
                });  
            
            $('#telefonos tbody').on('click',"button.botonBorrar", function()
                    {
                        let registro = tabla3.row($(this).parents('tr')).data();
            ...
            $('#telefonos tbody').on('click',"button.botonModificar", function()
                    {
                        ...
                        document.getElementById("cabecera").innerText = "Modificar teléfono"
